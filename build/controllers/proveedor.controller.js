...
const getAllProveedores = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const proveedores = yield proveedorService.getAllProveedores();
...
const getProveedorById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const proveedor = yield proveedorService.getProveedorById(Number(id));
        if (!proveedor)
...
const createProveedor = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield proveedorService.createProveedor(req.body);
...
const updateProveedor = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const proveedor = yield proveedorService.updateProveedor(Number(id), req.body);
...
const deleteProveedor = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const proveedor = yield proveedorService.deleteProveedor(Number(id));
        if (!proveedor)
            return res.status(404).json({ message: "Proveedor no encontrado" });
